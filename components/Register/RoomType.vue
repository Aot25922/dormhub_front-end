<template>
	<div class="px-3 md:px-20 lg:px-[335px]">
		<div  class="bg-dark-blue p-3 rounded-lg mb-3">
			...
			<input type="text" class="p-2 mb-5 rounded text-light-blue bg-dark-gray border-none focus:outline-none focus:bg-gray- input input-sm w-full disabled:bg-light-blue disabled:text-dark-blue"
			...
			<input type="number" class="p-2 mb-5 rounded text-light-blue bg-dark-gray border-none focus:outline-none focus:bg-gray- input input-sm w-full disabled:bg-light-blue disabled:text-dark-blue"
			...
			<h1 class="text-white text-lg ml-2 mb-2 font-bold">ภาพประเภทห้อง</h1>
					<div class="">
						<div class="mb-3 w-full">
							...
							<input class="mb-5 focus:outline-none form-control block w-full bg-dark-gray text-gray-soil input input-sm rounded transition ease-in-out border-none disabled:bg-light-blue disabled:text-dark-blue" type="file" id="formFileMultiple" @change="onFileChange" multiple :disabled="confirmAllRoomTypes" >
						</div>
