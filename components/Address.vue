<template>
	<div div class="bg-dark-blue p-3 rounded-lg my-3">
		<h1 class="text-white text-lg ml-2 mb-2 font-bold">{{ msg }}</h1>
			...
			<input class="py-4 px-2 w-full input-sm rounded text-light-blue bg-dark-gray focus:outline-none focus:bg-gray-soil focus:text-light-blue"
			placeholder="999/999"/>
			...
			<select v-model="selected" class="select w-full text-light-blue bg-dark-gray border-0">
			...
			<select v-model="selected" class="select w-full text-light-blue bg-dark-gray border-0"></select>
