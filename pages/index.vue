<template>
  ...
  <!-- Last Content -->
    <div class="p-5 bg-ghostWhite md:py-20 lg:p-20 lg:px-52 2xl:px-96">
      <h1 class="font-bold text-3xl md:pr-44 lg:pr-64 md:text-4xl lg:text-5xl">ค้นหาความเหมาะสมให้เข้ากับคุณในทุกด้าน ไม่ไหวอย่าฝืน</h1>
      <p class="py-3 md:pr-48 md:py-8 text-gray-500 md:text-md lg:text-lg">การอ่านหนังสือโดยไม่ได้คิดค้น การอ่านจะไม่ได้อะไรเลย การคิดค้นโดยไม่ได้อ่านหนังสือ การคิดค้นจะเปล่าประโยชน์</p>
